...
extension BasicStrategy {
    ...
    static var pairRules: [Rule] {
        return [
            ...
            Rule(type: .pair, dealerCardValue: 4, playerRuleValue: 10, action: .doNotSplit, deviations: [Deviation(type: .hard17, count: 6, direction: "+", action: .split), Deviation(type: .soft17, count: 6, direction: "+", action: .split)]),
            Rule(type: .pair, dealerCardValue: 5, playerRuleValue: 10, action: .doNotSplit, deviations: [Deviation(type: .hard17, count: 5, direction: "+", action: .split), Deviation(type: .soft17, count: 5, direction: "+", action: .split)]),
            Rule(type: .pair, dealerCardValue: 6, playerRuleValue: 10, action: .doNotSplit, deviations: [Deviation(type: .hard17, count: 4, direction: "+", action: .split), Deviation(type: .soft17, count: 4, direction: "+", action: .split)]),
    ...
    static var softRules: [Rule] {
        return [ // ace is implied
            ...
            Rule(type: .soft, dealerCardValue: 4, playerRuleValue: 8, action: .stand, deviations: [Deviation(type: .hard17, count: 3, direction: "+", action: .doubleStand), Deviation(type: .soft17, count: 3, direction: "+", action: .doubleStand)]),
            Rule(type: .soft, dealerCardValue: 5, playerRuleValue: 8, action: .stand, deviations: [Deviation(type: .hard17, count: 1, direction: "+", action: .doubleStand), Deviation(type: .soft17, count: 1, direction: "+", action: .doubleStand)]),
            Rule(type: .soft, dealerCardValue: 6, playerRuleValue: 8, action: .doubleStand, deviations: [Deviation(type: .hard17, count: 0, direction: "-", action: .stand), Deviation(type: .soft17, count: 1, direction: "+", action: .doubleStand), Deviation(type: .soft17, count: nil, direction: nil, action: .stand)]),
            ...
            Rule(type: .soft, dealerCardValue: 2, playerRuleValue: 6, action: .hit, deviations: [Deviation(type: .hard17, count: 1, direction: "+", action: .doubleHit), Deviation(type: .soft17, count: 1, direction: "+", action: .doubleHit)]),
    ...
    static var hardRules: [Rule] {
        return [
            ...
            Rule(type: .hard, dealerCardValue: 8, playerRuleValue: 16, action: .hit, surrender: Surrender(false, deviations: [Deviation(type: .hard17, count: 4, direction: "+", action: .surrender), Deviation(type: .soft17, count: 4, direction: "+", action: .surrender)])),
            
            Rule(type: .hard, dealerCardValue: 9, playerRuleValue: 16, action: .hit, deviations: [Deviation(type: .hard17, count: 4, direction: "+", action: .stand), Deviation(type: .soft17, count: 4, direction: "+", action: .stand)], surrender: Surrender(true, deviations: [Deviation(type: .hard17, count: -1, direction: "-", action: .hit), Deviation(type: .soft17, count: -1, direction: "-", action: .hit)])),
            
            Rule(type: .hard, dealerCardValue: 10,playerRuleValue: 16, action: .hit, deviations: [Deviation(type: .hard17, count: 0, direction: "+", action: .stand), Deviation(type: .soft17, count: 0, direction: "+", action: .stand)], surrender: Surrender(true)),
            ...
            Rule(type: .hard, dealerCardValue: 9, playerRuleValue: 15, action: .hit, surrender: Surrender(false, deviations: [Deviation(type: .hard17, count: 2, direction: "+", action: .surrender), Deviation(type: .soft17, count: 2, direction: "+", action: .surrender)])),
            
            Rule(type: .hard, dealerCardValue: 10,playerRuleValue: 15, action: .hit, deviations: [Deviation(type: .hard17, count: 4, direction: "+", action: .stand), Deviation(type: .soft17, count: 4, direction: "+", action: .stand)], surrender: Surrender(true, deviations: [Deviation(type: .hard17, count: 0, direction: "-", action: .hit), Deviation(type: .soft17, count: 0, direction: "-", action: .hit)])),
            
            Rule(type: .hard, dealerCardValue: 1, playerRuleValue: 15, action: .hit, deviations: [Deviation(type: .hard17, count: 5, direction: "+", action: .stand)], surrender: Surrender(false, deviations: [Deviation(type: .hard17, count: -1, direction: "+", action: .surrender), Deviation(type: .soft17, count: 2, direction: "+", action: .surrender)])),
            ...
            Rule(type: .hard, dealerCardValue: 2, playerRuleValue: 13, action: .stand, deviations: [Deviation(type: .hard17, count: -1, direction: "-", action: .hit), Deviation(type: .soft17, count: -1, direction: "-", action: .hit)]),
            ...
            Rule(type: .hard, dealerCardValue: 2, playerRuleValue: 12, action: .hit, deviations: [Deviation(type: .hard17, count: 3, direction: "+", action: .stand), Deviation(type: .soft17, count: 3, direction: "+", action: .stand)]),
            Rule(type: .hard, dealerCardValue: 3, playerRuleValue: 12, action: .hit, deviations: [Deviation(type: .hard17, count: 2, direction: "+", action: .stand), Deviation(type: .soft17, count: 2, direction: "+", action: .stand)]),
            Rule(type: .hard, dealerCardValue: 4, playerRuleValue: 12, action: .stand, deviations: [Deviation(type: .hard17, count: 0, direction: "-", action: .hit), Deviation(type: .soft17, count: 0, direction: "-", action: .hit)]),
            ...
            Rule(type: .hard, dealerCardValue: 1, playerRuleValue: 11, action: .doubleHit, deviations: [Deviation(type: .soft17, count: 1, direction: "+", action: .doubleHit), Deviation(type: .soft17, count: nil, direction: nil, action: .hit)]),
            ...
            Rule(type: .hard, dealerCardValue: 10,playerRuleValue: 10, action: .hit, deviations: [Deviation(type: .hard17, count: 4, direction: "+", action: .doubleHit), Deviation(type: .soft17, count: 4, direction: "+", action: .doubleHit)]),
            Rule(type: .hard, dealerCardValue: 1, playerRuleValue: 10, action: .hit, deviations: [Deviation(type: .hard17, count: 3, direction: "+", action: .doubleHit), Deviation(type: .soft17, count: 4, direction: "+", action: .doubleHit)]),
            
            Rule(type: .hard, dealerCardValue: 2, playerRuleValue: 9, action: .hit, deviations: [Deviation(type: .hard17, count: 1, direction: "+", action: .doubleHit), Deviation(type: .soft17, count: 1, direction: "+", action: .doubleHit)]),
            ...
            Rule(type: .hard, dealerCardValue: 7, playerRuleValue: 9, action: .hit, deviations: [Deviation(type: .hard17, count: 3, direction: "+", action: .doubleHit), Deviation(type: .soft17, count: 3, direction: "+", action: .doubleHit)]),
            ...
            Rule(type: .hard, dealerCardValue: 6, playerRuleValue: 8, action: .hit, deviations: [Deviation(type: .hard17, count: 2, direction: "+", action: .doubleHit), Deviation(type: .soft17, count: 2, direction: "+", action: .doubleHit)]),
