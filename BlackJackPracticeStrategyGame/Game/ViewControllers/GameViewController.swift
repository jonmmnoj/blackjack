...
extension GameViewController: GameViewDelegate {
    func showNoticeScalingView() {
        ...
        let alert = UIAlertController(title: "User Interface", message: "Card size and other table view settings are configurable. To access, tap on the gear icon.", preferredStyle: .alert)
